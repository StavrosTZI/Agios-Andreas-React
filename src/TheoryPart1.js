...
const TheoryPart1 = () => {
  ...
  useEffect(() => {
    const fetchChapters = async () => {
      try {
        const response = await api.get('https://localhost:8081/api/theory-parts/module-1');
  ...
  return (
    <div className='btns'>
      ...
      {currentChapter === 3 && (
      <button className='rightButton' onClick={() => navigate('/test1', { state: { myData: myData } })}>Πάμε στο πρώτο τέστ <br></br> &#8594;</button>
            )}
