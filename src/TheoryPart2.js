...
const TheoryPart2 = () => {
  ...
  useEffect(() => {
    const fetchChapters = async () => {
      try {
        const response = await api.get('https://localhost:8081/api/theory-parts/module-2');
  ...
  return (
    <div className='btns'>
      ...
      {currentChapter === 3 && (
      <button className='rightButton' onClick={() => navigate('/test2', { state: { myData: myData } })}>Πάμε στο δεύτερο τέστ <br></br> &#8594;</button>
            )}
